...
namespace domotique
{
    public partial class Form1 : Form
    {
        ...
        private void initialiserMaison()
        {
            ...
            TOuverture FCuisine = new TOuverture(ref labelFenetreCuisine, 20, 20);
            TOuverture PCuisine = new TOuverture(ref labelPorteCuisine, 20, 20);
            TOuverture FChambre = new TOuverture(ref labelFenetreChambre, 20, 20);
            TOuverture PChambre = new TOuverture(ref labelPorteChambre, 20, 20);
            TOuverture FSalon1 = new TOuverture(ref labelFenetreSalon, 20, 20);
            TOuverture FSalon2 = new TOuverture(ref labelFenetreSalon2, 20, 20);
            TOuverture PSalon = new TOuverture(ref labelPorteSalon, 20, 20);
