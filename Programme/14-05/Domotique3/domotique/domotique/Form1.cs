...
namespace domotique
{
    public partial class Form1 : Form
    {
        ...
        private void initialiserMaison(SqlConnection con)
        {
            ...
            TPiece monSalon = new TPiece("Salon", false, 15, 270, 1500, ref textBoxTSalonActuelle, ref textBoxTSalonConsigne, ref buttonChauffeSalon);
            TPiece maChambre = new TPiece("Chambre", false, 20, 150, 1000, ref textBoxTChambreActuelle, ref textBoxTChambreConsigne, ref buttonChauffeChambre);
            TPiece maCuisine = new TPiece("Cuisine", false, 20, 120, 500, ref textBoxTCuisineActuelle, ref textBoxTCuisineConsigne, ref buttonChauffeCuisine);
        ...
        private void buttonExcell_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridViewLogPiece.Rows.Count - 1; i++)
            {
                ...
                {
                    oSheet.Cells[i + 1, j + 1] = dataGridViewLogPiece[j, i].Value.ToString();
                }
            }
