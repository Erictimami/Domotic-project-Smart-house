...
namespace domotique
{
    public partial class Form1 : Form
    {
        ...
        private void initialiserMaison(SqlConnection con)
        {
            ...
            TPiece monSalon = new TPiece("Salon", false, 20, ref textBoxTSalonActuelle, ref textBoxTSalonConsigne);
            TPiece maChambre = new TPiece("Chambre", false, 20, ref textBoxTChambreActuelle, ref textBoxTChambreConsigne);
            TPiece maCuisine = new TPiece("Cuisine", false, 20, ref textBoxTCuisineActuelle, ref textBoxTCuisineConsigne);

            TOuverture FCuisine = new TOuverture(ref labelFenetreCuisine, 20, 20, con, labelHeure, labelDate, ref statusBDD);
            TOuverture PCuisine = new TOuverture(ref labelPorteCuisine, 20, 20, con, labelHeure, labelDate, ref statusBDD);
            TOuverture FChambre = new TOuverture(ref labelFenetreChambre, 20, 20, con, labelHeure, labelDate, ref statusBDD);
            TOuverture PChambre = new TOuverture(ref labelPorteChambre, 20, 20, con, labelHeure, labelDate, ref statusBDD);
            TOuverture FSalon1 = new TOuverture(ref labelFenetreSalon, 20, 20, con, labelHeure, labelDate, ref statusBDD);
            TOuverture FSalon2 = new TOuverture(ref labelFenetreSalon2, 20, 20, con, labelHeure, labelDate, ref statusBDD);
            TOuverture PSalon = new TOuverture(ref labelPorteSalon, 20, 20, con, labelHeure, labelDate, ref statusBDD);
        ...
        public void chercherConsigne()
        {
            ...
            for (int j = 0; j < maMaison.ListePieces.NbPieces; j++)
            {
                ...
                {
                    maMaison.ListePieces[j].Consigne = 0;
                }
                index = -1;
            }
