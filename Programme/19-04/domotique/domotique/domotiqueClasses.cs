...
namespace domotique
{
    ...
    public class TMaison : System.Object
    {
        ...
        public void gerer()
        {
            ...
            foreach (TPiece piece in this.ListePieces)
            {
                ...
                else if (piece.OuvertureCommuneOuvert() != null)
                {
                    piece.Radiateur = false;
                    int temperature;
                    temperature = Convert.ToInt32(((piece.OuvertureCommuneOuvert().Piece1.Temperature * piece.OuvertureCommuneOuvert().Piece1.Surface) + (piece.OuvertureCommuneOuvert().Piece2.Temperature * piece.OuvertureCommuneOuvert().Piece2.Surface)) / (piece.OuvertureCommuneOuvert().Piece1.Surface + piece.OuvertureCommuneOuvert().Piece2.Surface));
                ...
                else
                {
                    ...
                    foreach (TParoi paroi in piece.ListeParois)
                    {
                        ...
                        int temperatureKelvin = piece.Temperature * 273;
    ...
    {
        public TPiece(string ANom, bool ARadiateur, int ATemperature, int ASurface, int ACoefficientRadiateur, ref TextBox ATextBoxT, ref TextBox ATextBoxC, ref Button AButtonChauffage)
        {
            nom = ANom;
