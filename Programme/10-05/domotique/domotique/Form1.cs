...
namespace domotique
{
    public partial class Form1 : Form
    {
        ...
        private void initialiserMaison(SqlConnection con)
        {
            ...
            TOuverture FCuisine = new TOuverture(ref labelFenetreCuisine, 3, 1, con, labelHeure, labelDate, ref statusBDD, true);
            TOuverture PCuisine = new TOuverture(ref labelPorteCuisine, 2, 2, con, labelHeure, labelDate, ref statusBDD, true);
            TOuverture FChambre = new TOuverture(ref labelFenetreChambre, 3, 1, con, labelHeure, labelDate, ref statusBDD, true);
            TOuverture PChambre = new TOuverture(ref labelPorteChambre, 2, 2, con, labelHeure, labelDate, ref statusBDD, true);
            TOuverture FSalon1 = new TOuverture(ref labelFenetreSalon, 3, 1, con, labelHeure, labelDate, ref statusBDD, true);
            TOuverture FSalon2 = new TOuverture(ref labelFenetreSalon2, 3, 1, con, labelHeure, labelDate, ref statusBDD, true);
            TOuverture PSalon = new TOuverture(ref labelPorteSalon, 2, 2, con, labelHeure, labelDate, ref statusBDD, true);
        ...
        {
            //Debug.Print(statusStrip1.Items[0].Text.ToString());
